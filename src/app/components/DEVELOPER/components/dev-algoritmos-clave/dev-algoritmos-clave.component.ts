...
@Component({
  selector: 'app-dev-algoritmos-clave',
  templateUrl: './dev-algoritmos-clave.component.html',
  styleUrls: ['./dev-algoritmos-clave.component.css']
})
export class DevAlgoritmosClaveComponent implements OnInit {

  public idPublicacion = 'de48822e-c2f5-4274-a682-535a44456478';
