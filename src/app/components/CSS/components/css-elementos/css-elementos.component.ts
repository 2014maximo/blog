...
@Component({
  selector: 'app-css-elementos',
  templateUrl: './css-elementos.component.html',
  styleUrls: ['./css-elementos.component.css']
})
export class CssElementosComponent implements OnInit {

  public idPublicacion = '62161a6b-c446-4756-8cde-c98e7894934b';
